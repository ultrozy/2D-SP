 ...
 * Macros CPXDEPRECATED, CPXDEPRECATEDAPI, and CPXDEPRECATEDENUMVAL have a
 * single argument: The CPLEX version at which the function was deprecated.
 * This version number has the same format as CPX_VERSION.
 */
#ifdef BUILD_CPXLIB
...
#      define CPXDEPRECATEDENUMVAL(version)
...
#      if __GNUC__ > 6
#         define CPXDEPRECATEDENUMVAL(version) __attribute__ ((deprecated("since " #version)))
#      else
#         define CPXDEPRECATEDENUMVAL(version)
#      endif
...
#define CPX_VERSION               20010000
#define CPX_VERSION_VERSION       20
#define CPX_VERSION_RELEASE       1
...
/* CPX_PWL_MAXSLOPE: Any slope greater than or equal to this
 * can be a potential source of ill-conditioning or
 * numerical instability in a model. */
#define CPX_PWL_MAXSLOPE  1.0E+6

/* CPX_PWL_MINSLOPE: Any slope less than or equal to this
 * can be a potential source of ill-conditioning or
 * numerical instability in a model. */
#define CPX_PWL_MINSLOPE  1.0E-6
...
/* PREREFORM settings */
#define CPX_PREREFORM_ALL               3
#define CPX_PREREFORM_INTERFERE_CRUSH   1
#define CPX_PREREFORM_INTERFERE_UNCRUSH 2
#define CPX_PREREFORM_NONE              0
...
#define CPX_RELAXATION_FLAG_NOSOLVE 0x0001
...
#define CPXERR_NOT_FOR_DISTMIP 1071
...
#define CPXMI_PWL_SLOPE_LARGE_NUM 1064

#define CPXMI_PWL_SLOPE_SMALL_NUM 1065
...
#define CPXPARAM_Preprocessing_Reformulations 1167
#define CPXPARAM_Preprocessing_Relax 2034
#define CPXPARAM_Preprocessing_RepeatPresolve 2064
#define CPXPARAM_Preprocessing_SOS1Reform 2230
#define CPXPARAM_Preprocessing_SOS2Reform 2231
...
/* Deprecated since V20.1.0. */
#ifdef CPLEX_CONFIG_DUPLICATE_PARAMS
#   define CPX_PARAM_BENDERSFEASCUTTOL 1509
#endif /* #ifdef CPLEX_CONFIG_DUPLICATE_PARAMS */
#define CPX_PARAM_BENDERSFEASCUTTOL 1509
/* Deprecated since V20.1.0. */
#ifdef CPLEX_CONFIG_DUPLICATE_PARAMS
...
#define CPX_PARAM_NODECUTS 2157
...
#define CPX_PARAM_SOS1REFORM 2230
#define CPX_PARAM_SOS2REFORM 2231
